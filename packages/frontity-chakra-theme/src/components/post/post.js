...
const Post = ({ state, actions, libraries }) => {
  ...
  return (
    <LightPatternBox showPattern={state.theme.showBackgroundPattern} ref={ref} bg="#fff" pt="0">
      {!postData.isPage && <Box pb={{ base: "2rem", lg: "50px" }}>
       <PostHeader
      ...
      <Section bg="white" size="l00%">
       ...
       by the processors we included in the libraries.html2react.processors array. */}
        <Content
          ...
          px={{ base: "32px", md: "0" }}
          size="md"
          className="cw-content-container"
        >
